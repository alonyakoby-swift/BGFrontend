...
import Coverimage from '../../../assets/images/cover/coverimage.jpg';
            ...
            <Row className="hp-image-row hp-h-100 hp-pb-md-32">
                ...
                <Col span={24}>
                    <Row align="middle" justify="center" className="hp-h-100">
                        ...
                        {/*  <h2 className="hp-text-color-black-100 hp-text-color-dark-0 hp-mx-lg-16 hp-mb-16">Very good works are waiting for you.</h2>*/}
